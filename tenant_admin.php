...
<div style="overflow-x:auto;">
  ...
  display: inline-block;
         ...
         <tr>
            ...
            <th>Emergency Contact Person Phone</th>
        ...
        <?php
         ...
         <tr>
                    ...
                    <td>
                     <button><a href="edit_tenant.php?room_id=<?= $row['tenant_id'] ?>" style="text-decoration:none">Edit</a></button>
                     <button><a href="del2.php?room_id=<?= $row['tenant_id'] ?>" style="text-decoration:none" onclick="return confirm('Are you sure?');">Delete</a></button>
                    </td>
                  </tr>
                   <?php
                                }
